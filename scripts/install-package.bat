@echo off
REM User Access Summary App - Package Installation Guide
REM Package: UserAccessSummaryApp
REM Version: 1.0.0-1
...
echo • Subscriber Package Version Id: 04tgL0000004sLCQAY
echo • Installation Key: Not required (bypassed)
echo.

REM Alternative installation via CLI
echo 🛠️  Alternative: Install via Salesforce CLI
echo sf package install --package 04tgL0000004sLCQAY --installation-key-bypass --target-org YOUR_ORG_ALIAS
echo.
